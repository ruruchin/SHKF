/** Детальные промпты для Figma Make — SHKF Studio design system */
window.MAKE_STARTER_PROMPTS = {
  onboard: `Создай mobile onboarding flow для приложения SHKF. Фрейм iPhone 390×844, 4 отдельных экрана в едином стиле Studio. Каждый экран — отдельный frame с именем «01 Welcome», «02 Permissions», «03 Profile», «04 Success».

=== Дизайн-система SHKF Studio (строго соблюдать) ===
...
Generic purple/blue AI gradient hero. Material Design default cards. Emoji как иконки. Roboto/system default без Inter. Один экран вместо четырёх. Cartoon mascots. Auto layout на всех контейнерах, hug contents где нужно.`,
  ...
  dash: `Создай analytics dashboard для SHKF Studio. Desktop frame 1440×900, production UI — не wireframe, не placeholder lorem ipsum blocks.
...
Generic admin template с синим sidebar. Neon colors. 3D charts. Empty gray rectangles без данных. Comic icons. Default Bootstrap table.`,
  ...
  land: `Создай marketing landing page SaaS «SHKF Studio». Desktop 1440px width, premium minimal B2B — как Linear/Notion tier, не generic startup.

=== Navbar sticky 72px ===
Background white 80% + backdrop blur. Logo SHKF слева. Nav links center: Product, Features, Pricing, Docs — 14px medium #1C1C1E, gap 32px. Right: ghost «Sign in» + primary pill «Start free» #F97316. Border bottom 1px rgba(28,28,30,0.06).
...
Purple-pink gradient hero. «Get started for free» only CTA. Stock photos. Illustration of rocket. Intercom-style chat bubble.`,
  ...
  modal: `Создай destructive confirmation modal — компонент SHKF Studio. Canvas 800×600: dimmed app shell на фоне + centered dialog по центру.
